...
AdminUser.create!([
  {email: "admin@example.com", encrypted_password: "$2a$10$L6TejhR6SQsTCJ/riMR0AOYrHxKOnoLaGvRHr8LAEbHAmKiM/fs7K", reset_password_token: nil, reset_password_sent_at: nil, remember_created_at: nil, sign_in_count: 2, current_sign_in_at: "2015-08-11 12:46:02", last_sign_in_at: "2015-08-11 12:37:33", current_sign_in_ip: "127.0.0.1", last_sign_in_ip: "127.0.0.1"},
])
